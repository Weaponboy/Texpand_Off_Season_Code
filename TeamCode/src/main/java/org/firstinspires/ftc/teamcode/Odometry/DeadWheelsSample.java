...
public class DeadWheelsSample extends LinearOpMode {
    ...
    public static final double TRACKWIDTH = 34;
    ...
    public static final double WHEEL_DIAMETER = 30;
...
//        liftRight = new Motor(hardwareMap, "lift_right");
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            RB.setVelocity(slow*(-pivot + (vertical + horizontal)));
            LF.setVelocity(slow*(pivot + (vertical + horizontal)));
            LB.setVelocity(slow*(pivot + (vertical - horizontal)));
