...
@TeleOp
public class Blue_Driver_Old extends OpMode {
    ...
    public static final double TRACKWIDTH = 37;
...
//            }
        ...
        telemetry.addData("left pod", leftOdometer.getPosition());
        telemetry.addData("right pod", rightOdometer.getPosition());
