...
//        drive.LF.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
    ...
    public void init_loop() {
        ...
        telemetry.addData("S", colin.getS());
        telemetry.addData("V", colin.getV());
        telemetry.addData("H", colin.getH());
        telemetry.addData("con", colin.numcontours());
        telemetry.addData("rects", colin.getRects());
...
//        Distance_To_Travel = Distance_To_Travel / 20;
        ...
        if (Distance_To_Travel > 0){
            drive.StrafeDistance_Left(Distance_To_Travel*1.2, 0.6);
            drive.stopMotors();
            Distance_To_Travel = 0;
        }else if (Distance_To_Travel < 0){
            drive.StrafeDistance(-Distance_To_Travel*1.2, 0.6);
            drive.stopMotors();
            Distance_To_Travel = 0;
        }
